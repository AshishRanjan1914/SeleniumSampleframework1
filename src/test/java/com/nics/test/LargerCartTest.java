...
public class LargerCartTest extends BaseTest{
  ...
  public void EvaluationAgreementTest () {
	  try
	  {
	    ...
	    actions.MandateWWait5sec();
	    actions.WaitForEelementVisible(By.xpath("//div[@class='loading']"),30);
	    actions.WaitForEelementDisappear(By.xpath("//div[@class='loading']"),30);
	 
	    
	    actions.Click(By.xpath("//button//span[text()='Add More Products']"));
	    
	    
	    
	    
	    actions.ClickByJs(By.xpath("(//a[text()='ETT'])[2]"));
	    actions.Click(By.xpath("//label[@for='checkbox-all']"));
	    actions.MandateWWait2sec();
	    actions.Click(By.xpath("//span[text()='Add to Cart']"));
	    actions.MandateWWait5sec();
	    actions.Click(By.xpath("(//li[contains(@class,'numbers')]//a[text()='2'])[2]"));
	    actions.MandateWWait5sec();
	    actions.Click(By.xpath("//label[@for='checkbox-all']"));
	    actions.MandateWWait2sec();
	    actions.Click(By.xpath("//span[text()='Add to Cart']"));
	    actions.MandateWWait5sec();
	    actions.Click(By.xpath("(//li[contains(@class,'numbers')]//a[text()='3'])"));
	    actions.MandateWWait5sec();
	    actions.Click(By.xpath("//label[@for='checkbox-all']"));
	    actions.MandateWWait2sec();
	    actions.Click(By.xpath("//span[text()='Add to Cart']"));
	    ...
	    actions.Click(By.xpath("//span[text()='Go to Pricing']"));
	    actions.MandateWWait5sec();
	    actions.WaitForEelementVisible(By.xpath("//div[@class='loading']"),120);
	    actions.WaitForEelementDisappear(By.xpath("//div[@class='loading']"),120);
